...
import 'package:vender/app/backend/models/product_variations_model.dart';
import 'package:vender/app/backend/models/saved_variations_model.dart';
...
class Products {
  ...
  late List<SavedeVariationsModel> savedVariationsList;
  String? extraField;
  ...
  Products.fromJson(Map<String, dynamic> json) {
    ...
    if (json['savedVariationsList'] != null &&
      ...
      savedVariationsList = <SavedeVariationsModel>[];
      List<dynamic> list = jsonDecode(json['savedVariationsList']);
      for (var element in list) {
        savedVariationsList.add(SavedeVariationsModel.fromJson(element));
      }
