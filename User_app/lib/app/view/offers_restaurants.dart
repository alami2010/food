...
class OffersRestaurantScreen extends StatefulWidget {
  ...
  @override
  State<OffersRestaurantScreen> createState() => _OffersRestaurantScreenState();
}

class _OffersRestaurantScreenState extends State<OffersRestaurantScreen> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<OffersRestaurantsController>(builder: (value) {
      return Scaffold(
          appBar: AppBar(
            elevation: 0,
