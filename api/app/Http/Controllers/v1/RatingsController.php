...
class RatingsController extends Controller
{
    ...
    public function saveStoreRatings(Request $request){
        ...
        $updates = Stores::where('uid',$request->store_id)->update($request->only('total_ratings','ratings'));
        $response = [
            'data'=>$data,
            'success' => true,
            'status' => 200,
    ...
    public function getByProductId(Request $request){
        ...
        $data = Ratings::where('product_id',$request->id)->get();
        $response = [
            'data'=>$data,
            'success' => true,
            'status' => 200,
    ...
    public function saveProductRatings(Request $request){
        ...
        $updates = Products::where('id',$request->product_id)->update($request->only('rating'));
        $response = [
            'data'=>$data,
            'success' => true,
            'status' => 200,
    ...
    public function getStoreReviews(Request $request){
        ...
        $products = Products::select('id')->where('store_id',$request->id)->get();
        $ids = array();
